export const blogPosts = [
    ...
    {
        id: 2,
        title: 'ঢাকা বিশ্ববিদ্যালয়ের "ক" ইউনিটের মানবন্টন ও কৌশল',
    ...
    {
        id: 5,
        title: 'ইঞ্জিনিয়ারিং গুচ্ছ: গণিত প্রস্তুতির সেরা কৌশল',
        excerpt: 'ইঞ্জিনিয়ারিং গুচ্ছ ভর্তি পরীক্ষায় গণিতে ভালো করার জন্য গুরুত্বপূর্ণ টপিক এবং অনুশীলনের কৌশল নিয়ে বিস্তারিত আলোচনা।',
        author: 'মেহেদী হাসান',
        date: 'জুলাই ১৫, ২০২৪',
        imageId: 'blog-5',
