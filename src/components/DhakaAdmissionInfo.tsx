      ...
      <Tabs defaultValue="ka-unit" className="w-full">
        ...
        <TabsContent value="ka-unit">
          <div className="border border-border rounded-xl p-4 mt-2.5 text-base leading-relaxed">
            ...
            ● <b>MCQ:</b> ৬০, <b>লিখিত:</b> ৪০
            <hr className="my-1 border-border/50" />
            ● <b>মোট সময়:</b> ১.৫ ঘন্টা
            <hr className="my-1 border-border/50" />
          ...
          <Accordion type="multiple" className="w-full space-y-2 mt-2">
            <AccordionItem value="item-1-1" className="border border-border rounded-lg bg-card hover:bg-accent/50">
              ...
              <AccordionContent className="p-4 pt-0 text-base">
                <b>=&gt; মোট ৪টি বিষয় দাগাতে হবে।</b><br/><br/>
                <b>✓ দাগানো বাধ্যতামূলক -</b><br/>
                &nbsp;&nbsp;&nbsp; ○ পদার্থবিজ্ঞান<br/>
                &nbsp;&nbsp;&nbsp; ○ রসায়ন<br/>
                &nbsp;&nbsp;&nbsp; ○ মেইন সাবজেক্ট<br/><br/>
                <b>✓ মেইন সাবজেক্ট মিলে একটা বা দুটোই -</b><br/>
                &nbsp;&nbsp;&nbsp; ○ জীববিজ্ঞান<br/>
                &nbsp;&nbsp;&nbsp; ○ উচ্চতর গণিত<br/><br/>
                (মেইন সাবজেক্ট দাগানো বাধ্যতামূলক। না দাগালে রেজাল্ট আসবে না বা ফেল আসবে।)<br/><br/>
                <b>✓ জীববিজ্ঞান বা উচ্চতর গণিত না দাগালে যেকোনো একটি –</b><br/>
                &nbsp;&nbsp;&nbsp; ○ বাংলা<br/>
                &nbsp;&nbsp;&nbsp; ○ ইংরেজী<br/><br/>
                <div className="flex items-center"><Info size={14} className="mr-1" /> প্রতিটি বিষয়ের MCQ-15 ও লিখিত-10</div>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-1-2" className="border border-border rounded-lg bg-card hover:bg-accent/50">
              <AccordionTrigger className="p-3 text-base hover:no-underline">
                <div className="flex items-center">
                  <HelpCircle className="mr-2" />
        ...
        <TabsContent value="kha-unit">
          ...
          <Accordion type="single" collapsible className="w-full space-y-2 mt-2">
            <AccordionItem value="item-2-1" className="border border-border rounded-lg bg-card hover:bg-accent/50">
              <AccordionTrigger className="p-3 text-base hover:no-underline">
                <div className="flex items-center">
                  <HelpCircle className="mr-2" />
              ...
              <AccordionContent className="p-4 pt-0 text-base">
                <b>=&gt; মোট ৩টি বিষয় দাগাতে হবে।</b><br/><br/>
                <b>✓ দাগানো বাধ্যতামূলক -</b><br/>
                &nbsp;&nbsp;&nbsp; ➤ ইংরেজী<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ <b>MCQ -</b> প্রশ্ন: ১৫টি, নাম্বার: ১৫<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ <b>লিখিত -</b> প্রশ্ন: ৩টি, নাম্বার: ২০<br/>
                &nbsp;&nbsp;&nbsp; ➤ সাধারণ জ্ঞান<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ <b>MCQ -</b> প্রশ্ন: ৩০টি, নাম্বার: ৩০<br/><br/>
                <b>✓ সাধারণ শিক্ষার্থীরা দাগাবে -</b><br/>
                &nbsp;&nbsp;&nbsp; ➤ বাংলা<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ <b>MCQ -</b> প্রশ্ন: ১৫টি, নাম্বার: ১৫<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ <b>লিখিত -</b> প্রশ্ন: ৩টি, নাম্বার: ২০<br/><br/>
                <b>✓ যারা GCE/A Level পাশ করেছে, তারাই শুধুমাত্র দাগাবে –</b><br/>
                &nbsp;&nbsp;&nbsp; ➤ Elective English<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ <b>MCQ -</b> প্রশ্ন: ১৫টি, নাম্বার: ১৫<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ <b>লিখিত -</b> প্রশ্ন: ৩টি, নাম্বার: ২০
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </TabsContent>
        <TabsContent value="ga-unit">
          ...
          <Accordion type="multiple" className="w-full space-y-2 mt-2">
            <AccordionItem value="item-3-1" className="border border-border rounded-lg bg-card hover:bg-accent/50">
              <AccordionTrigger className="p-3 text-base hover:no-underline">
                <div className="flex items-center">
                  <HelpCircle className="mr-2" />
              ...
              <AccordionContent className="p-4 pt-0 text-base">
                <b>=&gt; মোট ৫টি বিষয় দাগাতে হবে।</b><br/><br/>
                <b>✓ দাগানো বাধ্যতামূলক -</b><br/>
                &nbsp;&nbsp;&nbsp; ○ বাংলা<br/>
                &nbsp;&nbsp;&nbsp; ○ ইংরেজি<br/>
                &nbsp;&nbsp;&nbsp; ○ হিসাববিজ্ঞান<br/>
                &nbsp;&nbsp;&nbsp; ○ ব্যবসায় সংগঠন ও ব্যবস্থাপনা<br/><br/>
                <b>✓ যেকোনো একটি –</b><br/>
                &nbsp;&nbsp;&nbsp; ○ উৎপাদন ব্যবস্থাপনা ও বিপণন<br/>
                &nbsp;&nbsp;&nbsp; ○ ফিন্যান্স, ব্যাংকিং ও বিমা<br/><br/>
                <div className="flex items-center"><Info size={14} className="mr-1" /> প্রতিটি বিষয়ের MCQ প্রশ্ন: ১২টি, নাম্বার: ১২ এবং লিখিত নাম্বার: ৮</div>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3-2" className="border border-border rounded-lg bg-card hover:bg-accent/50">
              <AccordionTrigger className="p-3 text-base hover:no-underline">
                <div className="flex items-center">
                  <HelpCircle className="mr-2" />
                  <span>অন্য বিভাগে কোন কোন বিষয় দাগাতে হবে?</span>
              ...
              <AccordionContent className="p-4 pt-0 text-base">
                ...
                &nbsp;&nbsp;&nbsp; ○ পরিসংখ্যান<br/>
                &nbsp;&nbsp;&nbsp; ○ অর্থনীতি<br/><br/>
                <div className="flex items-center"><Info size={14} className="mr-1" /> আইসিটি ব্যাতীত প্রতিটি বিষয়ের MCQ-১২ ও লিখিত-১০, আইসিটি এর MCQ-২৪ ও লিখিত-১০</div>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </TabsContent>
        <TabsContent value="cha-unit">
          <div className="border border-border rounded-xl p-4 mt-2.5 text-base leading-relaxed">
            ● <b>মোট নাম্বার:</b> ১০০ নাম্বার
            <hr className="my-1 border-border/50" />
            ● <b>MCQ:</b> ৪০, <b>অঙ্কন:</b> ৬০
            <hr className="my-1 border-border/50" />
            ● <b>মোট সময়:</b> ১.৫ ঘন্টা<br/><br/>
            <b>ক) বহুনির্বাচনি (MCQ) = ৪০ - সাধারণ জ্ঞান</b><br/>
            <div className="flex items-start text-sm mt-1">
              <AlertTriangle size={20} className="mr-1 text-orange-500 shrink-0 mt-0.5" />
              <b>নোট:</b> পরীক্ষায় মাধ্যমিক ও উচ্চ মাধ্যমিক পর্যায়ে পঠিত বাংলা ও ইংরেজিসহ চারুকলার বিভিন্ন বিভাগ সম্পর্কিত বা বিষয় ভিত্তিক প্রশ্ন এবং শিল্প, সাহিত্য, সংস্কৃতি, ইতিহাস, ঐতিহ্য, সমসাময়িক ঘটনাবলি বিষয়ে প্রশ্ন থাকে।
            </div><br/>
            <b>খ) অঙ্কন = ৬০</b><br/>
            অঙ্কন পরীক্ষায় হিউম্যান ফিগার ড্রইংয়ের (মানুষের বিভিন্ন দেহ ভঙ্গির ফটোগ্রাফ) প্রশ্ন থাকে।
          </div>
        </TabsContent>
        <TabsContent value="iba-unit">
          <Accordion type="multiple" className="w-full space-y-2 mt-2">
             <AccordionItem value="item-5-1" className="border border-border rounded-lg bg-card hover:bg-accent/50">
              <AccordionTrigger className="p-3 text-base hover:no-underline">
                <div className="flex items-center">
                  <HelpCircle className="mr-2" />
              ...
              <AccordionContent className="p-4 pt-0 text-base">
                এটি ঢাকা বিশ্ববিদ্যালয়ের একটি স্বতন্ত্র ইউনিট। পরীক্ষাও আলাদা ধাচে হবে। লিখিত ও মৌখিক দুই ধাপে হবে।<br/><br/>
                <ExternalLink href="/IBA/" text="আইবিএ এর সম্পূর্ণ বিস্তারিত রিভিউ" /><br/><br/>
                আইবিএ মূলত বিবিএ এর মডিফায়েড ভার্সন। বিবিএ'র প্রফেশনালস ভার্সন আইবিএ। ঢাকা বিশ্ববিদ্যালয় ছাড়াও জাহাঙ্গীরনগর ও রাজশাহী বিশ্ববিদ্যালয়েও আইবিএ ডিপার্টমেন্ট রয়েছে তবে আইবিএ বলতে মূলত ঢাকা বিশ্ববিদ্যালয়ের আইবিএ'ই বুঝায় এবং জাহাঙ্গীরনগর ও রাজশাহী বিশ্ববিদ্যালয় থেকেই আলাদা ঢাকা বিশ্ববিদ্যালয়ের আইবিএ ইউনিট। আর দেশের কর্পোরেট ওয়ার্ল্ডের টপ লেভেলের ম্যাগনেটদের অধিকাংশই ঢাকা বিশ্ববিদ্যালয়ের এই ইউনিট থেকে পাস করা।<br/><br/>
                সাধারণ বা মাদ্রাসা যেকোন শিক্ষাবোর্ডের যেকোন বিভাগের (বিজ্ঞান,বাণিজ্য ও মানবিক) শিক্ষার্থীরা আবেদন ও পরীক্ষা দিতে পারবে। বাংলা ও ইংরেজি উভয় মিডিয়ামের শিক্ষার্থীরা পরীক্ষা দিতে পারবে।<br/><br/>
                আইবিএ ইউনিটে প্রস্তুতির জন্য নির্দিষ্ট ও ধরাবাধা কোন সিলেবাস নেই। তবে ইংরেজিতে সাধারণত Grammar, Comprehension ও Vocabulary উপর ভিত্তি করে প্রশ্ন করা হয়। গণিতে সাধারণত বীজগণিত, পাটিগণিত ও জ্যামিতি থেকে প্রশ্ন হয়। আর Analytical Ability এর প্রশ্নে বৈচিত্র‍্য থাকলেও Puzzle matching, Critical Reasoning বা কোন ঘটনার সবচেয়ে সঠিক কারণ নির্ণয় করা, Data Sufficiency বা প্রদত্ত তথ্য যথেষ্ট কি না ইত্যাদি থাকে।<br/><br/>
                প্রতিটি বিষয়ে আলাদা আলাদা ভাবে পাস করতে হবে। প্রচলিত নিয়ম অনুযায়ী, প্রতিটি বিষয়ে ৬০% নাম্বার না পেলে উত্তীর্ণ হওয়ার সম্ভাবনা কম।<br/><br/>
                আইবিএ তে মোট আসন সংখ্যা ১২০ টি। লিখিত পরীক্ষার পর সাধারণত মৌখিক পরীক্ষার জন্য ১৬০-১৮০ জনকে নির্বাচিত করা হয়। পরবর্তীতে মৌখিক পরীক্ষার ভিত্তিতে ১২০ জন চূড়ান্ত ভর্তির সুযোগ পায়।<br/><br/>
          ...
          <div className="border border-border rounded-xl p-4 mt-2.5 text-base leading-relaxed">
            ● <b>মোট নাম্বার:</b> ১০০ নাম্বার
            <hr className="my-1 border-border/50" />
            ● <b>MCQ:</b> ৭০, <b>বর্ণনামূলক:</b> ৩০
            <hr className="my-1 border-border/50" />
            ● <b>মোট সময়:</b> ২ ঘন্টা
          </div>
          <Accordion type="single" collapsible className="w-full space-y-2 mt-2">
            <AccordionItem value="item-5-2" className="border border-border rounded-lg bg-card hover:bg-accent/50">
              <AccordionTrigger className="p-3 text-base hover:no-underline">
                <div className="flex items-center">
                  <HelpCircle className="mr-2" />
                  <span>মানবন্টন, নুন্যতম নাম্বার ও কোন কোন বিষয় দাগাতে হবে?</span>
                </div>
              </AccordionTrigger>
              <AccordionContent className="p-4 pt-0 text-base">
                <b>=&gt; নিম্নলিখিত সব বিষয় দাগাতে হবে।</b><br/><br/>
                <b>✓ বহুনির্বাচনি (MCQ) -</b><br/>
                &nbsp;&nbsp;&nbsp; ➤ ইংরেজী<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ মোট নাম্বার: ৩০<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ নুন্যতম পেতে হবে: ১০<br/>
                &nbsp;&nbsp;&nbsp; ➤ গণিত<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ মোট নাম্বার: ২৫<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ নুন্যতম পেতে হবে: ৮.৩৩<br/>
                &nbsp;&nbsp;&nbsp; ➤ বিশ্লেষণাত্মক দক্ষতা<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ মোট নাম্বার: ১৫<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ নুন্যতম পেতে হবে: ৫<br/><br/>
                <b>✓ বর্ণনামূলক –</b><br/>
                &nbsp;&nbsp;&nbsp; ➤ Argumentative writing/Descriptive writing/Critical writing/Thematic writeup etc.<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ মোট নাম্বার: ৩০<br/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ○ নুন্যতম পেতে হবে: ১৫
              </AccordionContent>
            </AccordionItem>
