...
const GeneralAdmissionInfo = () => {
  return (
    ...
    >
      ...
      >
        <Timer className="mr-2" /> পরীক্ষার সময়কাল
      </h2>
      <div className="border border-border/80 p-3 text-center rounded-md text-sm sm:text-base">
        সব বিশ্ববিদ্যালয়ের <b>পরীক্ষার তারিখ ও কাউন্টডাউন</b> দেখতে ভিজিট করুন
        আমাদের{" "}
        <b>
          <ExternalLink
            href="https://mnr.world/ac/"
      ...
      <h2
        ...
        className="bg-primary/10 text-primary rounded-xl p-3 my-4 text-center text-lg sm:text-xl font-bold flex items-center justify-center"
      >
        <BarChart3 className="mr-2" /> ভর্তি পরীক্ষার ফলাফল
      </h2>
      <span className="text-sm sm:text-base">
        ● <b>ফলাফল প্রকাশ:</b> সাধারণত ভর্তি পরীক্ষার ১-৪ সপ্তাহের মধ্যেই ফলাফল
        প্রকাশিত হয়।
        ...
        প্রতিটি বিশ্ববিদ্যালয়ের নিজস্ব ওয়েবসাইটে ফলাফল পাবেন।
      </span>
    </div>
  );
};
