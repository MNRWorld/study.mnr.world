...
const DhakaMainInfoCard = () => {
  return (
    <>
      <div className="text-xs sm:text-sm text-foreground absolute top-[76px] sm:top-[81px] left-[22px] sm:left-[38px] bg-card border border-border rounded-[8px] px-3 py-1 z-20">
        <b>পাবলিক</b>
      </div>
      <PageHeaderCard
        icon={
