        ...
        >
            ...
            <hr className="my-2 border-border/50" />
             ...
             <div className="text-base">
                <b><LinkIcon className="inline-block mr-2" size={16}/>লিংকঃ</b> <ExternalLink href={apply.link} text={apply.link.replace('http://','').replace('/','')} /><br/><br/>
            ...
            <div className="border border-border/80 p-3 text-center rounded-md">
             ...
             <span className="text-base">● <b>ফলাফল প্রকাশ:</b> {result.date}
                <hr className="my-1 border-border/50" />
                <b><LinkIcon className="inline-block mr-2" size={16}/>লিংকঃ</b> <ExternalLink href={result.link} text={result.link.replace('http://','').replace('/','')} />
            </span>
        </div>
    );
};
