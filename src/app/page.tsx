...
export default function HomePage() {
  ...
  const features = [
    ...
    { href: "/university/dhaka", icon: <University className="h-10 w-10 sm:h-12 sm:w-12 mx-auto text-primary mb-2 sm:mb-3" />, label: "পাবলিক" },
  ...
  return (
    <HomePageClient studyPlatformImage={studyPlatformImage} features={features} />
  );
}
