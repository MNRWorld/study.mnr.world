    ...
    <div className="font-bengali bg-[#F0F5FA] my-[30px]">
      <div className="container mx-auto px-4">
        ...
        <div id="Info" className="mt-2.5 w-full border border-gray-300 bg-white rounded-2xl p-[17px] shadow-[0_4px_20px_#e8e8e8] relative text-left">
            ...
            <h5 id="AdmitCard" className="bg-blue-50 text-blue-800 rounded-xl p-3 my-[15px] mt-4 text-center text-lg font-bold flex items-center justify-center"><Contact className="mr-2"/> প্রবেশপত্র</h5>
