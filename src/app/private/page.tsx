            ...
            <Table className="border-dotted border-border/50 border-[1px]">
                <TableBody>
                    <TableRow>
                     ...
                     <TableRow>
                        <TableCell className="text-center text-sm sm:text-base" colSpan={2}><Link href="https://www.ugc.gov.bd/site/view/universities" target="_blank">সকল অনুমোদিত প্রাইভেট বিশ্ববিদ্যালয়ের তালিকা</Link></TableCell>
                    </TableRow>
                </TableBody>
            </Table>
        </div>
