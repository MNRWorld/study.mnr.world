    ...
    <div className="font-bengali bg-background py-8">
      <div className="container mx-auto px-4">
            ...
            <Table className="border-dotted border-border/50 border-[1px]">
                <TableBody>
                    <TableRow className="flex flex-col sm:flex-row">
                     ...
                     <TableRow>
                        <TableCell className="text-center text-sm sm:text-base" colSpan={2}><Link href="https://www.ugc.gov.bd/site/view/universities" target="_blank" className="block w-full hover:bg-accent p-2 rounded-md">সকল অনুমোদিত প্রাইভেট বিশ্ববিদ্যালয়ের তালিকা</Link></TableCell>
                    </TableRow>
                </TableBody>
            </Table>
        </div>
        ...
        <div id="Circular" className="mt-8 w-full border border-border bg-card rounded-2xl p-4 sm:p-6 shadow-lg text-center relative">
            ...
            <div className="text-center">
                <span className="text-base sm:text-lg"><b>বিভিন্ন বিশ্ববিদ্যালয়ের সার্কুলার</b></span><br/>
                <span className="text-muted-foreground text-xs sm:text-sm">(⚠ <b>নোট:</b> নিজ নিজ বিশ্ববিদ্যালয়ের ওয়েবসাইটে সর্বশেষ সার্কুলার পাওয়া যাবে।)</span>
            </div>
        ...
        <div id="Info" className="mt-8 w-full border border-border bg-card rounded-2xl p-4 sm:p-6 shadow-lg relative text-left">
            ...
            <span className="text-sm sm:text-base"><b>➜ আবেদন শুরু ও শেষঃ</b> প্রতিটি বিশ্ববিদ্যালয়ের নিজস্ব ওয়েবসাইটে ভিন্ন ভিন্ন সময়ে আবেদন গ্রহণ করা হয়।</span>
            ...
            <h5 id="ExamDate" className="bg-primary/10 text-primary rounded-xl p-3 my-4 text-center text-lg sm:text-xl font-bold flex items-center justify-center"><Timer className="mr-2"/> পরীক্ষার সময়কাল</h5>
             <span className="text-sm sm:text-base">প্রতিটি বিশ্ববিদ্যালয়ের নিজস্ব সময়সূচী অনুযায়ী পরীক্ষা অনুষ্ঠিত হয়।</span>
            <hr className="my-2 border-border/50"/>
