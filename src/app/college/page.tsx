            ...
            <Table className="border-dotted border-border/50 border-[1px]">
                <TableBody>
                    <TableRow>
                        ...
                        <TableCell className="text-center text-sm sm:text-base"><Link href="/question-bank">প্রশ্নব্যাংক</Link></TableCell>
                    </TableRow>
                    <TableRow>
                        <TableCell className="text-center text-sm sm:text-base"><Link href="http://xiclassadmission.gov.bd/" target="_blank" rel="noreferrer noopener">মূল ওয়েবসাইট</Link></TableCell>
                        <TableCell className="text-center text-sm sm:text-base"><Link href="http://xiclassadmission.gov.bd/" target="_blank" rel="noreferrer noopener">এডমিশন ওয়েবসাইট</Link></TableCell>
                    </TableRow>
                </TableBody>
            </Table>
        </div>
