        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-card border border-border rounded-2xl p-6 sm:p-8 shadow-lg">
                ...
                <div className="prose prose-lg max-w-none text-foreground/90">
                    <p>{post.excerpt}</p>
                    <p>এটি একটি ডেমো ব্লগ পোস্ট। সম্পূর্ণ ব্লগ পোস্টের বিষয়বস্তু এখানে যুক্ত করা হবে।</p>
                    <p>ভর্তি পরীক্ষা, পড়াশোনা এবং ক্যারিয়ার গঠনের প্রতিটি ধাপে সঠিক দিকনির্দেশনা পেতে আমাদের সাথে থাকুন।</p>
                </div>
            </div>
        </div>
      </div>
